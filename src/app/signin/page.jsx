        ...
        <div className="flex w-screen h-screen">
            ...
            <div className="basis-1/2 bg-healtick-cream rounded-l-lg flex justify-center items-center">
                <div className="w-3/4 h-full relative flex flex-col justify-center items-center">
                    ...
                    <button className="flex flex-row w-full justify-center items-center text-white bg-blue-400 font-semibold gap-2 rounded-md border px-6 py-3 my-2">
                        <span>
                            <FcGoogle />
                        </span>
                        Login with Google
                    ...
                    <div>
                        Belum punya akun?{" "}
                        <span>
                            <Link href="/signup">Daftar disini</Link>
                        </span>
                    </div>
                </div>
            </div>
